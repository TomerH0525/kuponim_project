          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                {...register("name", {
                  required: true,
                  validate: value => value.length >= 2 || "Name length must be above 2 characters"
                })}
                error={Boolean(formState.errors.name)}
                helperText={formState.errors.name && formState.errors.name.message ? formState.errors.name.message : formState.errors.name ? "Must Enter company name" : null}
            ...
            <Grid item xs={12}>
              ...
              color: "black", '&:hover': {
                ...
                {Boolean(formState.errors.email || formState.errors.password) ? "Form Incomplete" : "Add Company"}
              </Button>
            </Grid>
          </Grid>
        </form>
